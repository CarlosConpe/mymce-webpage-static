...
<meta name="description" content="Open your browser's developer tools on this page to follow along...."><link rel="canonical" href="https://www.grupomymce.com/node_modules/lunr/"></head>
<body>
  <div class="wrap">
    <header>
      <h1>lunr.js en San Luis Potosí</h1>
    ...
    <section class="columns">
      <article>
        ...
        <p>Open your browser's developer tools on this page to follow along. Estamos orgullosos de servir a todo San Luis Potosí con la mejor calidad.</p>

        <p>Set up an index for your notes:</p>
        <pre>  var index = lunr(function () {
